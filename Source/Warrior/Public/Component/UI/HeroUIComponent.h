...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnSurvivalStartMessageRequestedDelegate, const FText&, MessageToDisplay, float, DisplayDuration);
...
public:
	...
	UPROPERTY(BlueprintCallable, BlueprintAssignable)
	FOnSurvivalStartMessageRequestedDelegate OnSurvivalStartMessageRequested;
};
