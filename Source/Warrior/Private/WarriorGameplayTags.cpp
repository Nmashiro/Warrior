...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_Toggleable_Cheat, "InputTag.Toggleable.Cheat");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_Cheat, "Player.Ability.Cheat");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_AvtivateRage, "Player.Event.AvtivateRage");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Block_Successful, "Player.Status.Block.Successful");
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Block_Perfect, "Player.Status.Block.Perfect");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Cheater, "Player.Status.Cheater");
