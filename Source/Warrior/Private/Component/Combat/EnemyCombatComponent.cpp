...
void UEnemyCombatComponent::OnHitTargetActor(AActor* HitActor)
{
	...
	UWarriorFunctionLibrary::RemoveGameplayTagFromActorIfFound(HitActor, WarriorGameplayTags::Player_Status_Block_Successful);
	...
	if (bIsValidBlock)
	{
		UWarriorFunctionLibrary::AddGameplayTagToActorIfNone(HitActor, WarriorGameplayTags::Player_Status_Block_Successful);
