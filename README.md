...
Warrior 是一个基于 Unreal Engine 5.7 开发的第三人称动作游戏项目。项目以近战战斗为核心，使用 Gameplay Ability System 构建角色能力、攻击、受击、怒气、格挡、翻滚、拾取和敌人行为等系统。部分学习于udemy的第三人称RPG游戏制作教程，并在此之上进行了功能增添和部分bug修复。部分音效资源来源于免费音频网站，暂不公开，一首boss音乐来源于付费资源，已为个人购买使用版权，其余缺失音乐资源均为个人制作，暂不公开。
